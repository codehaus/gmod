...
import org.kordamp.jsilhouette.geom.Cross
...
public class CrossGraphicsOperation extends AbstractShapeGraphicsOperation {
    ...
    public static optional = AbstractShapeGraphicsOperation.optional + ['width','angle','roundness']

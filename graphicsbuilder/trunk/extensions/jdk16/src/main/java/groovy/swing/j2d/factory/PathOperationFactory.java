   ...
   public void setParent( FactoryBuilderSupport builder, Object parent, Object child ) {
      if( parent instanceof ContextualGraphicsOperation ){
         ...
         if( delegate instanceof PathGraphicsOperation ){
            ((PathGraphicsOperation) delegate).addPathOperation( (PathGraphicsOperation.PathOperation) child );
         }
      }else if( parent instanceof PathGraphicsOperation ){
         ((PathGraphicsOperation) parent).addPathOperation( (PathGraphicsOperation.PathOperation) child );
      }
   }
}
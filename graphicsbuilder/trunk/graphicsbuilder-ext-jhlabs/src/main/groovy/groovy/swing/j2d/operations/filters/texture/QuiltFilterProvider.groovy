 ...
 */
class QuiltFilterProvider extends PropertiesBasedFilterProvider implements ColormapAware {
   public static required = ['iterations','a','b','c','d','k','colormap']

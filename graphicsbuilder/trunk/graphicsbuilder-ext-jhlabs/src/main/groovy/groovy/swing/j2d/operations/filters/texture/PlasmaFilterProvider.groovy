 ...
 */
class PlasmaFilterProvider extends PropertiesBasedFilterProvider implements ColormapAware {
   public static required = ['seed','scaling','turbulence','useColormap','useImageColors','colormap']

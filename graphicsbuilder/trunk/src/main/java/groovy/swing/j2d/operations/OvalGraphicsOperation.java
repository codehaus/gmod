 ...
 */
public class OvalGraphicsOperation extends StrokingAndFillingGraphicsOperation implements
      FillSupportGraphicsOperation {
   public OvalGraphicsOperation() {
      super( "drawOval", new String[] { "x", "y", "width", "height" } );
   }

 ...
 */
public class OperationFactory extends AbstractGraphicsOperationFactory {
   public Object newInstance( FactoryBuilderSupport builder, Object name, Object value,
      ...
      if( FactoryBuilderSupport.checkValueIsType( value, name, GraphicsOperation.class ) ){
         ...
         throw new RuntimeException( name + " must have a value argument of "
               + GraphicsOperation.class.getName() + " or a property named " + name + " of type "
               + GraphicsOperation.class.getName() );
      }
   }
}
 ...
 */
public class RoundRectGraphicsOperation extends StrokingAndFillingGraphicsOperation implements
      FillSupportGraphicsOperation {
   public RoundRectGraphicsOperation() {
      super( "drawRoundRect", new String[] { "x", "y", "width", "height", "arcWidth", "arcHeight" } );
   }
   ...
   public Shape getClip(Graphics2D g, ImageObserver observer) {
      ...
      int height = ((Number) getParameterValue( "height" )).intValue();

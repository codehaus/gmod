...
/**
 * Experimental mix of BuilderSupport and SwingBuilder's factory support.
 */
public abstract class FactoryBuilderSupport extends GroovyObjectSupport {
    ...
    * setDelegate() method on the closure which by default passes in this but if
    * node is-a builder we could pass that in instead (or do something wacky
    * too)
    *

...
public class ReflectAttribute implements Attribute {
  ...
  public ReflectAttribute(MetaClass declaringMetaClass,Field field) {
  ...
  public Closure getGetter() {
    if (getter == null) {
      try {
        ...
        getter = new ReflectClosure(/*varags=*/false, mh);
  ...
  public Closure getSetter() {
    if (setter == null) {
      try {
        ...
        setter = new ReflectClosure(/*varags=*/false, mh);
      } catch (NoAccessException e) {
        throw RT.unsafeThrow(e);
      }
    }

...
public class JVMProperty implements Property {
  ...
  public JVMProperty(MetaClass declaringMetaClass, int modifiers, String name, MetaClass type, Closure getter, Closure setter) {

...
public class ReflectMethod extends ReflectClosure implements Method {
  ...
  public ReflectMethod(MetaClass declaringMetaClass, int modifiers, String name, MethodHandle mh) {
